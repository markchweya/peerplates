...
// brown-ish from your logo vibe (tweak if you want a slightly darker/lighter)
...
function VendorIcon({ className = "" }: { className?: string }) {
  // person + chef hat silhouette (simple, clean)
  return (
  ...
  return (
    ...
    >
      <span className="relative flex h-2.5 w-2.5 items-center justify-center">
        ...
        <span
          className={cn(
            "absolute h-6 w-6 rounded-full blur-xl transition-opacity",
...
function CinematicSection({
  ...
  // ✅ no “already blurred” on load: we only fade OUT near the end
  ...
  return (
    <section ref={ref} className="relative min-h-screen">
      {/* Cinematic background (soft “food glow” motion) */}
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="rounded-3xl border border-slate-200 bg-white/75 backdrop-blur p-6 sm:p-7 shadow-sm">
              ...
              <div className="mt-3 text-slate-600 font-semibold leading-relaxed">
                We ordered a big bowl of jollof rice from a local home cook — and realised: authentic, great-value
                food is nearby… but discovery + ordering needed to feel effortless.
              </div>
            </div>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-[34px] border border-slate-200 bg-white/75 backdrop-blur p-7 shadow-sm">
              ...
              <div className="mt-4 text-slate-600 font-semibold leading-relaxed">
                Our team works closely with vendors as they grow — with priority onboarding, practical guidance, and
                clear resources on best-practice food safety, so quality remains consistent as businesses expand.
              </div>
